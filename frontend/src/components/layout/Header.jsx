...
const PRIMARY_NAV = [
  { key: "home", path: "/" },
  { key: "kifisha", path: "/shop-ship" },
  { key: "track", path: "/track" },
  { key: "estimate", path: "/calculate" },
];
    ...
    <>
      <header
        className={[
          ...
          scrolled
            ? "shadow-[0_1px_0_rgba(15,23,42,0.06),0_10px_30px_-18px_rgba(15,23,42,0.25)]"
        ...
        <div className="shell-md flex h-[76px] items-center gap-3 lg:h-20">
          ...
          <div className="ml-auto flex items-center gap-2 lg:ml-0 xl:ml-3">
            ...
            <button
              ...
              aria-controls="swiftkifisha-navigation-drawer"
              className="flex h-11 w-11 shrink-0 items-center justify-center rounded-xl border border-border bg-white text-foreground transition-colors hover:bg-surface focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/30"
            >
              <Menu
                className="h-5 w-5"
                strokeWidth={2}
        ...
        <div className="border-t border-border/60 px-5 pb-3 pt-3 sm:px-7 lg:hidden">
          ...
          >
            ...
            <Input
              ...
              placeholder={t(
                "header.searchPlaceholderMobile",
              )}
              aria-label={t(
                "header.trackingIdAria",
              )}
      ...
      {/* IMPORTANT:
          Drawer is outside <header> so its fixed positioning
          is always relative to viewport and not affected
          by the sticky/backdrop-blur header.
      */}
      <SideDrawer
        open={menuOpen}
        onClose={() =>
